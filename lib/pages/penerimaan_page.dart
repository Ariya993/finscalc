...
import 'penerimaan_form.dart';

class PenerimaanPage extends StatelessWidget {
  final controller = Get.put(PenerimaanController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Penerimaan')),
      body: Obx(() {
        ...
        final data = controller.filteredPenerimaan;
        ...
        return Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              Expanded(
                child: controller.penerimaanList.isEmpty
        ...
        Row(
          ...
          children: [
            TextButton.icon(
              onPressed: () {
                Get.to(() => PenerimaanForm(), arguments: item);
              },
            ...
            TextButton.icon(
              onPressed: () {
                Get.defaultDialog(
                  ...
                  onConfirm: () async {
                    await controller.deletePenerimaan(item['id']);
                    Get.back();
                  },
                );
              },
